...
public class AccountController {
    ...
    private CreateAccount createAccountCommand(String username, String usernameKey) {
        return new CreateAccount(UUID.randomUUID(), UUID.randomUUID(), Instant.now(), username, usernameKey);
    }
